...
```sh
java -jar package-explorer-converter-0.3.1.jar -i data/model.json -o data/mode-converted.json
```
...
```sh
java -jar package-explorer-converter-0.3.1.jar -i data/ -o output/ --merge
```
